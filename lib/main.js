...
gcli.addCommand({
  name: 'proxy use manual',
    ...
    exec: function(args, content) {
      return ProxyManager.applyManualConfig(args.http, args.ssl, args.ftp, args.socks, args.excludes);
    }
});
...
gcli.addCommand({
  name: 'proxy add manual',
    ...
    returnType: 'string',
    exec: function(args, content) {
      return ProxyManager.applyManualConfig(args.http, args.ssl, args.ftp, args.socks, args.excludes, args.name);
    }
});
